        ...
        {isSuccess ? (
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                onClick={onClose}
                className={`${canReauthorize ? "flex-1" : "w-full"} rounded-2xl border border-white/15 bg-white/[0.06] px-4 py-3 text-sm font-bold text-white transition-colors hover:bg-white/[0.1]`}
              >
                Done
              </button>
            </div>
